...
export function Navigation() {
  ...
  const navItems = [
    ...
    { id: "check", href: "/check", icon: Check },
    { id: "text", href: "/text", icon: Type },
        ...
        <div className="flex items-center justify-between h-14">
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-1 hover:text-gray-50 px-2 py-1 rounded-md cursor-pointer transition-colors">
                <div className="w-7 h-7 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full hover:scale-105 transition-transform cursor-pointer"></div>
          ...
          <div className="flex items-center space-x-1 bg-[#f6f6f6] rounded-lg p-2">
            {navItems.map((item) => {
              ...
              return (
                <Link href={item.href} key={item.id}>
                  <Button
                    ...
                    className={`h-8 w-10 px-3 transition-all duration-200 cursor-pointer ${
                      isActive
